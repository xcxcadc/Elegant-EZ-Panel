...
export default {
  ...
  shop: {
    ...
    aiGuide: {
      eyebrow: 'Глобальная поддержка AI',
      title: 'Все доступные тарифы поддерживают ведущие AI-сервисы',
      description: 'Все тарифы в продаже поддерживают такие популярные AI-сервисы, как ChatGPT, Claude, Gemini и Grok. Выберите любой тариф, чтобы начать; фактическая доступность зависит от сети и правил провайдера.',
      badge: 'Поддержка всех тарифов'
    },
