...
export default {
  ...
  shop: {
    ...
    aiGuide: {
      eyebrow: 'پشتیبانی جهانی از AI',
      title: 'همه بسته‌های موجود از سرویس‌های اصلی AI پشتیبانی می‌کنند',
      description: 'تمام بسته‌های قابل خرید از سرویس‌هایی مانند ChatGPT، Claude، Gemini و Grok پشتیبانی می‌کنند. هر بسته‌ای را انتخاب کنید و شروع کنید؛ دسترسی واقعی به شرایط شبکه و قوانین ارائه‌دهنده بستگی دارد.',
      badge: 'پشتیبانی همه بسته‌ها'
    },
